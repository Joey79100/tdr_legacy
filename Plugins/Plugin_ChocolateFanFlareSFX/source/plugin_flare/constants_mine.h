...
#define ID_MAXIMUM 511

#define PERSISTENCE_DEFAULT 6

#define FLIPEFFECT_ASSIGN_FIRST 1
#define FLIPEFFECT_ASSIGN_SECOND 2
#define FLIPEFFECT_ASSIGN_NONE 3

#define CONDITION_SOUND_EFFECT 85

#define TIMER_OBJ_GEM_SMASH 285

#define BIT_NINTH 256
